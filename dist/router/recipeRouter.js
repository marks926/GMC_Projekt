...
const recipeModel = __importStar(require("../models/recipe"));
...
recipeRouter.get("/", async (req: Request, res: Response) => {
  recipeModel.findAll((err: Error, orders: Order[]) => {
    if (err) {
...
recipeRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    recipeModel.create(newRecipe, (err, recipeID) => {
        if (err) {
...
recipeRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    recipeModel.findRecipe(recipeID, (err, recipe) => {
        if (err) {
            return res.status(500).json({ "message": err.message });
        }
